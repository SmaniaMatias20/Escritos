...
function Writing({ title, description, date, url, ranking }) {
    return (
        <a href={url} target="_blank" rel="noopener noreferrer">
            <div className="mx-auto p-6 m-4 rounded-xl shadow-2xl bg-white dark:bg-[#1f0148] text-gray-800 dark:text-white transform transition duration-300 ease-in-out hover:scale-105 relative space-y-4">
